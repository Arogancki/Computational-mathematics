...
Shape::Shape(bool _includes, std::vector<Point2D> _base, std::vector<Point2D> _side1, std::vector<Point2D> _side2)
{
...
Shape ShapeBuilder::getShape(bool _includes)
{
	...
	return Shape(_includes, this->base, this->side1, this->side2);
}
